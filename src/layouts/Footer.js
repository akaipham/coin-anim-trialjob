      ...
      <footer>
        <div className="container">
          <div className="row-fluid">
            <div className="span2 footer__logo">
              <a href="/" className="brand">
                <svg xmlns="http://www.w3.org/2000/svg" width="122" height="28" viewBox="0 0 122 28" role="button" style={{
                    width: '96px',
                    height: '22px',
                    fill: '#0667d0',
                    cursor: 'pointer'
              ...
              <br/>
              <small>
                <span>© 2018 Coinbase</span>
              </small>
            </div>
            <div className="span2">
              <h4 className="collapsible__toggle">Products</h4>
              <nav className="collapsible">
            ...
            <div className="span2">
              <h4 className="collapsible__toggle">Learn</h4>
              <nav className="collapsible">
            ...
            <div className="span2">
              <h4 className="collapsible__toggle">Company</h4>
              <nav className="collapsible">
                <a href="/about">About</a>
                <a href="/careers">Careers</a>
                <a href="/press">Press</a>
                <div className="dropup dropdown-hover">
                  ...
                  <ul className="dropdown-menu fadeIn animated-fast" role="menu" aria-labelledby="dLabel">
                    ...
                    <li>
                      <a href="/legal/licenses">Licenses &amp; Disclosures</a>
                    </li>
                  </ul>
                </div>
            ...
            <div className="span2">
              <h4 className="collapsible__toggle">Social</h4>
              <nav className="collapsible">
            ...
            <div className="span2">
              <div className="footer-locale-select">
                <h4>Language</h4>
                <p>
                  <select name="locale" id="locale_select" defaultValue="en">
